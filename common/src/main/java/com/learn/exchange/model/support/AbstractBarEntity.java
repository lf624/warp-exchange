...
public class AbstractBarEntity implements EntitySupport{
    ...
    public String toString(ZoneId zoneId) {
        ...
        return String.format("{%s: startTime=%s, O=%s, H=%s, L=%s, C=%s, qty=%s}",
                this.getClass().getSimpleName(), time, this.openPrice, this.highPrice,
                this.lowPrice, this.closePrice, this.quantity);
    }
